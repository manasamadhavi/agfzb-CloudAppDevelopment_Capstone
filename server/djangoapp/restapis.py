    ...
    if json_result:
        ...
        for dealer_doc in reviews:
            ...
            dealer_obj = DealerReview(dealership=dealer_doc["dealership"], name=dealer_doc["name"], purchase=dealer_doc["purchase"],
                                   ...
                                   car_model=dealer_doc["car_model"], car_year=dealer_doc["car_year"],sentiment =review_obj.sentiment, id=dealer_doc["id"])
        results.append(dealer_obj)
...
# - Get the returned sentiment label such as Positive or Negative
    ...
    api_key = "yT6P6OmuzLmTpzPJA4yXgHhEn229E0y49g8h6IsSf17X"
